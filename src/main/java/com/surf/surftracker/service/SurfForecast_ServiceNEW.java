...
public class SurfForecast_ServiceNEW {
//    private Current LowersCurrent;
//
//    public SurfForecast_ServiceNEW(Current LowersCurrent) {
...
//    };
    ...
    public String getSurfForecastCurrent(String sFurl) {
        try {
                Document sfConnect = Jsoup.connect(sFurl)
                ...
                if (tdElement != null) {
                    ...
                    if (textElement != null) {
                        ...
                        int intWave = (int) Math.round(Double.parseDouble(waveHeight) * 3.048);
                          surfForecastWaveHeight = String.format("%d ft", intWave);

                        System.out.println("Surf Captain Wave is " + surfForecastWaveHeight);
                       // LowersCurrent.setSurfForecastWaveHeight(formattedWave);

                        System.out.println("Wave height: " + surfForecastWaveHeight);
                    } else {
                        // System.out.println("Wave height value not found");
                        surfForecastWaveHeight = "N/A";
                    }
                } else {
